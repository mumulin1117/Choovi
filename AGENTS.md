...
本文件是 Choovi 的核心开发规范指南。Codex 在执行任何代码修改、UI 还原、逻辑重构或功能迭代时，必须严格遵守本指南，以确保包的代码特征与 App Store 审核规范完全合规。
...
* **App 标题：Choovi
* **App 副标题：
* **蓝湖设计链接： https://lanhuapp.com/web/#/item/project/stage?pid=8b16c32d-e764-4042-b335-fcfd7f17e73b&tid=8c379c32-0bd6-44ae-ab3b-cfb09ffccdbf


* **App Store 描述：
Coffee has a mood, and Choovi gives it a place to live.

Capture a morning espresso, a rainy-day latte, a new café discovery, or a homemade brew as a short video. Add a mood, a few words, and coffee details to turn each post into a personal Coffee Moment.

Browse the community to discover café atmospheres, latte art, and everyday stories shared by other coffee lovers. Reactions and comments make it easy to exchange ideas about flavors, equipment, recipes, and the small moments behind every cup.

Choovi also offers coffee-themed group chats for topics such as home brewing, café visits, bean recommendations, and seasonal drinks. Users choose which groups to join and what information to share.

Privacy and community safety are built into the experience. Choovi provides reporting, blocking, content moderation, and user-controlled profiles to help reduce unwanted interactions and keep conversations respectful.

Brew it. Film it. Share the mood.
---
...
### 6.1 固定测试账号
账号：choovi@gmail.com    密码：23452345
...
5. **落盘持久化：** 注册流程完毕后，将用户数据同步写入本地，将全局变量 `choovilogin` 设为 `true`，`hooviEmail` 设为当前邮箱。
